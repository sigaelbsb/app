...
export const CategoryDashboard = () => {
  ...
  const handleSubmoduloClick = (vista: string) => {
    if (
      ...
      (decodedCategory === "Gestión Estudiantil" && (vista === "Gestión de Admisiones" || vista === "Solicitud de Cupos" || vista === "Vincular Estudiante" || vista === "Actualización de Datos" || vista === "Verificaciones")) ||
